...
// Function to set the dark theme by default
const setDarkTheme = () => {
...
if (!selectedTheme) {
    setDarkTheme(); // Set dark theme by default if not chosen previously
} else {
...
new Typewriter('#typewriter', {
  strings: ['Aryan Mundra',  'Computer-Engineer', 'Startup Founder',  ' '],
  autoStart: true,
  loop: true,
  cursor: "|"
});
